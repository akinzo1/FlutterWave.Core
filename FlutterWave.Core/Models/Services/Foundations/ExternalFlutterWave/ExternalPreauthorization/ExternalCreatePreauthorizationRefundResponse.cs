...
{
    internal class ExternalCreatePreauthorizationRefundResponse
    {
        ...
        [JsonProperty("data")]
        public ExternalCreatePreauthorizationRefundData Data { get; set; }
        ...
        public class ExternalCreatePreauthorizationRefundData
        {
            [JsonProperty("id")]
            public int Id { get; set; }
