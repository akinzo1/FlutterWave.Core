...
{
    internal class ExternalCreateCollectionSubaccountResponse
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("data")]
        public ExternalCreateCollectionSubaccountData Data { get; set; }

        public class ExternalCreateCollectionSubaccountData
        {
            [JsonProperty("id")]
