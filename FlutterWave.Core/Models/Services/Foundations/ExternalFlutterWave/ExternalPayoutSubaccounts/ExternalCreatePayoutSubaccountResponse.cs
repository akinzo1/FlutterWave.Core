...
{
    internal class ExternalCreatePayoutSubaccountResponse
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("data")]
        public ExternalCreatePayoutSubaccountData Data { get; set; }

        public class ExternalCreatePayoutSubaccountData
        {
            [JsonProperty("id")]
