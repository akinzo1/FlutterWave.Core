...
{
    internal class ExternalUpdatePayoutSubaccountResponse
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("data")]
        public ExternalUpdatePayoutSubaccountData Data { get; set; }

        public class ExternalUpdatePayoutSubaccountData
        {
            [JsonProperty("id")]
