...
{
    internal class ExternalCreateTokenizedChargeResponse
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("data")]
        public ExternalCreateTokenizedChargeData Data { get; set; }
        ...
        public class ExternalCreateTokenizedChargeData
        {
            [JsonProperty("id")]
            public int Id { get; set; }
