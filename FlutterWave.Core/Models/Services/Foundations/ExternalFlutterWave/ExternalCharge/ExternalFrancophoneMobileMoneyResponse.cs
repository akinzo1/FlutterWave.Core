...
{
    internal class ExternalFrancophoneMobileMoneyResponse
    {
        [JsonProperty("status")]
        ...
        [JsonProperty("data")]
        public ExternalFrancophoneMobileMoneyData Data { get; set; }
        ...
        public class ExternalFrancophoneMobileMoneyData
        {
            [JsonProperty("id")]
            public int Id { get; set; }
