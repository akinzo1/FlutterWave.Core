...
{
    internal class ExternalCardChargeResponse
    {
        ...
        [JsonProperty("data")]
        public ExternalCardChargeData Data { get; set; }

        [JsonProperty("meta")]
        public ExternalCardChargeMeta Meta { get; set; }
        ...
        public class ExternalCardChargeData
        {
            [JsonProperty("id")]
            public int Id { get; set; }
        ...
        public class ExternalCardChargeMeta
        {
