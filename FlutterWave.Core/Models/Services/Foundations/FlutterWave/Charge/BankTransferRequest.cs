...
namespace FlutterWave.Core.Models.Services.Foundations.FlutterWave.Charge
{
    public class BankTransferRequest
    {
        ...
        public BankTransferOption BankTransferOptions { get; set; }

        [JsonProperty("meta")]
        public BankTransferMeta Meta { get; set; }

        [JsonProperty("subaccounts")]
        public BankTransferSubaccounts Subaccounts { get; set; }

        public class BankTransferOption
        {
        ...
        public class BankTransferSubaccounts
        {
            [JsonProperty("id")]
