...
namespace FlutterWave.Core.Tests.Unit.Services.Foundations.BillPayment
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnValidateBillPaymentsRequestIfUrlNotFoundAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
            string someCustomer = GetRandomString();
            ...
            this.flutterWaveBrokerMock.Setup(broker =>
                broker.GetValidateBillServiceAsync(someItemCode, someCode, someCustomer))
                    .ThrowsAsync(httpResponseUrlNotFoundException);

            // when
            ValueTask<ValidateBillService> retrieveBillPaymentTask =
               this.billPaymentsService.GetValidateBillServiceAsync(someItemCode, someCode, someCustomer);
        ...
        public async Task ShouldThrowDependencyExceptionOnValidateBillPaymentsRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnValidateBillPaymentsRequestIfNotFoundOccurredAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnValidateBillPaymentsRequestIfBadRequestOccurredAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnValidateBillPaymentsRequestIfTooManyRequestsOccurredAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnValidateBillPaymentsRequestIfHttpResponseErrorOccurredAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnValidateBillPaymentsRequestIfServiceErrorOccurredAsync()
        {
            // given
            string someItemCode = GetRandomString();
            string someCode = GetRandomString();
