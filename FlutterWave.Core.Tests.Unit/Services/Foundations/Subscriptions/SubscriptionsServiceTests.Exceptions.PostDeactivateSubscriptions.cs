...
namespace FlutterWave.Core.Tests.Unit.Services.Foundations.Subscriptions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnDeactivateSubscriptionsRequestIfUrlNotFoundAsync()
        {
            // given
            ...
            this.flutterWaveBrokerMock.Setup(broker =>
                broker.PostDeactivateSubscriptionAsync(someSubscriptionsId))
                    .ThrowsAsync(httpResponseUrlNotFoundException);

            // when
            ValueTask<Subscription> retrieveSubscriptionsTask =
               this.subscriptionsService.PostDeactivateSubscriptionAsync(someSubscriptionsId);
        ...
        public async Task ShouldThrowDependencyExceptionOnSubscriptionsRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnSubscriptionsRequestIfNotFoundOccurredAsync()
        {
            // given
            string someSubscriptionsId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnSubscriptionsRequestIfBadRequestOccurredAsync()
        {
            // given
            string someSubscriptionsId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnSubscriptionsRequestIfTooManyRequestsOccurredAsync()
        {
            // given
            string someSubscriptionsId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnSubscriptionsRequestIfHttpResponseErrorOccurredAsync()
        {
            // given
            string someSubscriptionsId = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSubscriptionsRequestIfServiceErrorOccurredAsync()
        {
            // given
            string someSubscriptionsId = GetRandomString();
