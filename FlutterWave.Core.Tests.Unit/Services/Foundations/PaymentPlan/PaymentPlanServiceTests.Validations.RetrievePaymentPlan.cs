...
namespace FlutterWave.Core.Tests.Unit.Services.Foundations.PaymentPlans
{
    public partial class PaymentPlanServiceTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnRetrievePaymentPlanWithPaymentPlanIdDataIsInvalidAsync(
            string invalidPaymentPlanReference)
        {
            ...
            ValueTask<PaymentPlan> retrievePaymentPlanTask =
                this.paymentPlanService.GetPaymentPlanAsync(invalidPaymentPlanReference);
